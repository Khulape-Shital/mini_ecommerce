...
export declare const getCustomerById: (req: Request, res: Response, next: NextFunction) => Promise<void>;
export declare const updateCustomer: (req: Request, res: Response, next: NextFunction) => Promise<void>;
export declare const deleteCustomer: (req: Request, res: Response, next: NextFunction) => Promise<void>;
